...
public struct CardComposer: Sendable {
    ...
    public func composeText(senderID: UUID, senderDisplayName: String, senderNumber: Int? = nil, text: String, back: String? = nil) -> Card {
        ...
        return Card(senderID: senderID, senderDisplayName: senderDisplayName, senderNumber: senderNumber, sides: sides)
    }
